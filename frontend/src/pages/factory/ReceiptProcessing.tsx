      ...
      <View style={pdfStyles.footer}>
        <View style={{ marginBottom: 8 }}>
          <Text style={{ fontSize: 8, color: '#64748b', marginBottom: 3 }}>
            {creator && `Created by: ${creator.userName} on ${new Date(creator.timestamp).toLocaleDateString()}`}
          </Text>
          <Text style={{ fontSize: 8, color: '#64748b' }}>
            {submitter && submitter !== creator && `Submitted by: ${submitter.userName} on ${new Date(submitter.timestamp).toLocaleDateString()}`}
          </Text>
        </View>
