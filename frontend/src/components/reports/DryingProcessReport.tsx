        ...
        <View style={styles.infoGrid}>
          ...
          <View style={styles.infoColumn}>
            <View style={styles.row}>
              ...
              <Text style={styles.value}>{formatTZ(process.startTime)}</Text>
            </View>
            {process.endTime && (
              <View style={styles.row}>
                <Text style={styles.label}>End Time:</Text>
                <Text style={styles.value}>{formatTZ(process.endTime)}</Text>
              </View>
            )}
            <View style={styles.row}>
              ...
              {process.recharges.map((recharge) => (
                <View key={recharge.id} style={styles.tableRow}>
                  <Text style={[styles.tableCell, { width: '25%' }]}>
                    {formatTZ(recharge.rechargeDate)}
                  </Text>
